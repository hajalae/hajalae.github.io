...
<head>
	...
	<meta property="og:url" content="http://mister-alae.com/next-projects" />
	...
	<section id="portfolio" class="portfolio-section">
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="/next-projects">Next Projects</a></li>
			</ol>
		</div>
		<div class="container text-center">
			...
			<br />
			<br />
			<h2 class='text-center'>Night Portraits</h2>
			<br />
			<div class="row">
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-1.jpg" class="img-fluid" />
				</div>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-2.jpg" class="img-fluid" />
				</div>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-3.jpg" class="img-fluid" />
				</div>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-4.jpg" class="img-fluid" />
				</div>
			</div>
			<div class='row'>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-5.jpg" class="img-fluid" />
				</div>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-6.jpg" class="img-fluid" />
				</div>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
					<img src="../assets/img/next-projects/night-portraits/night-portraits-7.jpg" class="img-fluid" />
				</div>
				<div class='col-sm-6 col-md-3' style='margin-bottom:30px'>
