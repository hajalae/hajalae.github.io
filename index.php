...
<head>
	<meta charset="utf-8">
	<title>Mister Alae - Photography</title>


	<meta property="og:type" content="website" />
	<meta property="og:title" content="Mister Alae - Photography" />
	<meta property="og:url" content="http://www.mister-alae.com/" />
	<meta property="og:image" content="http://mister-alae.com/assets/img/banner/ogimage.jpg" />
	<meta property="og:description" content="French Photographer around the world. Fashion, Street Photography, Sports, Festivals... No excuses to take pictures all the time" />

	<meta name="keywords" content="Mister Alae, Photography, Fashion, Street Photography, Sport Photography, Festivals, Festivals Photography, Photographer, filmaker">
				...
				<div class="banner-content">
					<div class="page-head-content">
						<div class="page-head-title text-capitalize pb40">
							<h1>Mister Alae</h1>
							<span class="descrip">French photographer around the world</span>
						</div>
						<!-- //title -->
				...
				<div class="item active">
					<a href="/videos/#sick">
						...
						<div class="carousel-caption mb10">
							...
							<p class="hidden-xs hidden-sm ">Un jeune prépa prêt à tout pour réussir</p>
						</div>
					</a>
				</div>
				...
				<div class="item">
					<a href="/videos/#menuires">
						...
						<div class="carousel-caption mb10">
							...
							<p class="hidden-xs hidden-sm ">Une semaine dans la poudreuse des alpes</p>
						</div>
					</a>
				</div>
				...
				<div class="item">
					<a href="/videos/#fanny-inge">
						...
						<div class="carousel-caption mb10">
							...
							<p class="hidden-xs hidden-sm ">Oui, on peut être une fille et être ingénieur</p>
						</div>
					</a>
				</div>
				...
				<div class="item">
					<a href="/videos/#jesuisqui">
						...
						<div class="carousel-caption mb10">
							...
							<p class="hidden-xs hidden-sm ">Vivre avec une mémoire courte n'est pas toujours aisé</p>
						</div>
					</a>
				</div>
				...
				<div class="item">
					<a href="/videos/#nuitdelessec">
						...
						<div class="carousel-caption mb10">
							...
							<p class="hidden-xs hidden-sm ">Plus grande soirée étudiante de France</p>
						</div>
					</a>
				</div>
				...
				<div class="item">
					<a href="/videos/#california">
						...
						<div class="carousel-caption mb10">
							...
							<p class="hidden-xs hidden-sm ">Living the dream in the West-Coast</p>
						</div>
					</a>
				</div>
